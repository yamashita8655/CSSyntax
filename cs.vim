...
" TODO:
syn keyword csUnspecifiedStatement	as base checked event fixed in is lock operator out params ref sizeof stackalloc this unchecked unsafe using async await
" TODO:
...
" 20220309 これ有効化すると、// コメントがおかしくなるので、無効か中
...
" Attributes
syn region csAttribute start="^\s*\[" end="\]\s*" contains=csString, csVerbatimString, csVerbatim2String, csCharacter, csNumber, csType
...
syn region	csPreCondit
    \ start="^\s*#\s*\(define\|undef\|if\|elif\|else\|endif\|line\|error\|warning\|pragma\)"
...
syn region  csVerbatim2String	start=+$"+ end=+"+ skip=+""+ contains=csVerbatimSpec,csNewStringFormat,@Spell
syn match   csVerbatim2Spec	+$"+he=s+1 contained
...
hi def link csNewStringFormat		SpecialChar
hi def link csString			String
hi def link csVerbatimString		String
hi def link csVerbatimSpec		SpecialChar
hi def link csVerbatim2String		String
hi def link csVerbatim2Spec		SpecialChar
